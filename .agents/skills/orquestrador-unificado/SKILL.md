...
- Produzir: `reports/BASELINE.md` (seções “Descoberto”, “ASSUMIDO”, “NÃO VERIFICADO”)
...
- Produzir:
  - `reports/BASELINE.md` (métricas + metodologia)
...
Para cada achado, registre em `reports/BACKLOG.md`:
...
Consolidar em `reports/BACKLOG.md`.
...
- atualizar `reports/VALIDATION.md` com PASS/FAIL antes/depois
- registrar diffs/commits em `reports/CHANGES.md`
...
A) `reports/EXEC_SUMMARY.md` (5–12 bullets)
B) `reports/BASELINE.md` (confirmado vs ASSUMIDO vs NÃO VERIFICADO)
C) `reports/SYSTEM_MAP.md` (componentes + 3–5 fluxos E2E)
D) `reports/BACKLOG.md` (achados + priorização)
E) `reports/CHANGES.md` (patches/commits + onde aplicar + rollback)
F) `reports/VALIDATION.md` (PASS/FAIL antes/depois)
G) `reports/RELEASE_CHECKLIST.md` (QA/Release/rollback)
